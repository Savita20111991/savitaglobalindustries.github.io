        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            ...
            <div className="space-y-6 text-slate-600 leading-relaxed">
              ...
              <p>
                Our mother company, <strong>Savita Global Interprises</strong>, provides the strategic foundation that allows us to innovate and scale across complex machinery and high-precision SS components.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2rem] shadow-xl overflow-hidden border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-5">
              <div className="md:col-span-2 relative h-96 md:h-auto">
                <img 
                  src={INITIAL_LEADERSHIP.ceo.image} 
                  alt="CEO" 
              ...
              <div className="md:col-span-3 p-8 md:p-16 flex flex-col justify-center">
                <div className="mb-8">
                  <h2 className="text-3xl font-bold text-slate-900 mb-2">{INITIAL_LEADERSHIP.ceo.name}</h2>
                  <p className="text-blue-600 font-bold uppercase tracking-widest text-sm">{INITIAL_LEADERSHIP.ceo.designation}</p>
                </div>
                <div className="relative italic text-xl text-slate-700 leading-relaxed mb-8">
                  ...
                  {INITIAL_LEADERSHIP.ceo.message}
                </div>
          ...
          <div className="bg-white rounded-[2rem] shadow-xl overflow-hidden border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-5">
              <div className="md:col-span-3 p-8 md:p-16 flex flex-col justify-center order-2 md:order-1">
                <div className="mb-8">
                  <h2 className="text-3xl font-bold text-slate-900 mb-2">{INITIAL_LEADERSHIP.opsHead.name}</h2>
                  <p className="text-blue-600 font-bold uppercase tracking-widest text-sm">{INITIAL_LEADERSHIP.opsHead.designation}</p>
                </div>
                <div className="relative italic text-xl text-slate-700 leading-relaxed mb-8">
                  <span className="absolute -top-6 -left-4 text-6xl text-blue-100 font-serif">"</span>
                  {INITIAL_LEADERSHIP.opsHead.message}
                </div>
                <div className="h-1 w-20 bg-blue-600 rounded"></div>
              </div>
              <div className="md:col-span-2 relative h-96 md:h-auto order-1 md:order-2">
                <img 
                  src={INITIAL_LEADERSHIP.opsHead.image} 
                  alt="Operations Head" 
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-blue-900/40 to-transparent"></div>
