...
import { CATEGORIES, COMPANY_NAME } from '../constants';
      ...
      <section className="relative h-[90vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight max-w-4xl">
            Powering Global Industry with <span className="text-blue-400">Precision Engineering</span>
          </h1>
      ...
      <section className="bg-white py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            { label: 'Precision Parts', value: '5000+' },
